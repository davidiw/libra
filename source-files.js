...
sourcesIndex["bytecode_interpreter"] = {"name":"","dirs":[{"name":"concrete","files":["local_state.rs","mod.rs","player.rs","runtime.rs","settings.rs","ty.rs","value.rs"]},{"name":"shared","files":["bridge.rs","ident.rs","mod.rs","variant.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["forge"] = {"name":"","dirs":[{"name":"backend","files":["k8s.rs","local.rs","mod.rs"]},{"name":"interface","files":["admin.rs","factory.rs","mod.rs","network.rs","node.rs","public.rs","swarm.rs","test.rs"]}],"files":["lib.rs","runner.rs","tx_emitter.rs"]};
